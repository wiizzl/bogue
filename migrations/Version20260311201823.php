 ...
 */
final class Version20260311201823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, promotion_year INT NOT NULL, is_archived TINYINT NOT NULL, major_id INT NOT NULL, INDEX IDX_B723AF33E93695C7 (major_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
